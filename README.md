...
**Due date: Thursday, Nov 6th @ 11:59 PM PST**
...
## Task 1: Testing and Implementation of HashMap and HashSet [95 points]
...
### Part 2: Implementation of HashMap and HashSet (70 points)
...
A core goal of this course is to teach students how to identify the time complexity (Big-O notation) of an algorithm. In practice, you can use this to understand how the runtime of an algorithm will grow with larger and larger inputs. In this section, you will test your understanding on Hash Table's `add` method. This time, you only need to fill out the form on Gradescope.

**Your task:** Fill out **PA5 Task 2: Runtime** form on Gradescope. This will **NOT** be eligible for resubmission.
...
* **Correctness** [90 points] You will earn points based on the autograder tests that your code passes. If the autograder tests are not able to run (e.g., your code does not compile or it does not match the specifications in this writeup), you may not earn credit.
    ...
    * HashMap/HashSet Implementation [70 points]
...
* **Runtime** (5 points)
    * Fill out **PA5 Task 2: Runtime** on Gradescope.
